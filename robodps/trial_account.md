...
Open the browser and go [here](http://8.152.212.170:27019/public/dashboard/6667a609-a8df4b01-9c46-8a942440788d) to access the data dashboard.  
...
### Object Distribution: 
Display the distribution of objects across different categories or types within the dataset.  
...
$\bigcirc$ Database: Select the source database (e.g., **db_public**).  
